			...
			this.on('JSONReady.' + NS, function(event) {
				...
				$.each(panels, function(index, value) {
					...
					if (typeof panel.backgroundLink !== 'undefined') {
						backgroundLink = $('<a href="../../../../accordion/dist/js/' + panel.backgroundLink.address + '"></a>');
					...
					if (typeof panel.backgroundOpenedLink !== 'undefined') {
						backgroundOpenedLink = $('<a href="../../../../accordion/dist/js/' + panel.backgroundOpenedLink.address + '"></a>');
			...
			this.on('XMLReady.' + NS, function(event) {
				...
				xmlData.find('panel').each(function() {
					...
					if (xmlBackgroundLink.length >= 1) {
						backgroundLink = $('<a href="../../../../accordion/dist/js/' + xmlBackgroundLink.text() + '"></a>');
					...
					if (xmlBackgroundOpenedLink.length >= 1) {
						backgroundOpenedLink = $('<a href="../../../../accordion/dist/js/' + xmlBackgroundOpenedLink.text() + '"></a>');
